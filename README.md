...
当前版本为 `0.3.2-neoforge-1.21.1`，输出文件为 `lib/vss-0.3.2-neoforge-1.21.1.jar`。配置结构和网络协议使用独立的内部版本标记。0.3.2 的世界生成档案改用分片传输，NeoForge 协议由 46 升至 47，服务端与所有 VSS 客户端需要一起更新。
